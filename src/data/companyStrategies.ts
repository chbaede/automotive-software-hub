  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        url: 'https://shareholder.ford.com/financials/quarterly-results/default.aspx',
        sourceType: 'investor-presentation',
    ...
    sources: [
      ...
      },
      {
        title: {
          ...
          ko: '닛산 자동차 공식 IR 라이브러리 및 경영 발표 아카이브',
        },
    ...
    sources: [
      {
        title: {
          ...
          ko: '지리 자동차 홀딩스 공식 투자자 센터 (공시 및 통지)',
        },
      ...
      },
      {
        title: {
          ...
          ko: '지리 자동차 홀딩스 공식 재무 문서 및 전략 공시',
        },
