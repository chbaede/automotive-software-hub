...
export const companyStrategies: CompanyStrategyInsight[] = [
    ...
    sources: [
      ...
      },
      {
        title: {
          ...
          ko: 'GM 인베스터 데이 소프트웨어 및 전기차 전략 공식 발표',
        },
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        url: 'https://shareholder.ford.com/events-and-presentations',
        sourceType: 'investor-presentation',
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        url: 'https://www.stellantis.com/en/news/press-releases/2021/december/stellantis-sets-software-strategy',
  ...
  },
  {
    ...
    irUrl: 'https://www.renaultgroup.com/en/investors/',
    latestEventOrReport: {
    ...
    sources: [
      {
        title: {
          en: 'Renault Group Investor Relations Financial Portal',
          ko: '르노 그룹 공식 IR 금융 포털',
        },
        url: 'https://www.renaultgroup.com/en/investors/',
        sourceType: 'official-website',
        publishedDate: '2024-04-23',
        lastVerified: '2026-09-13',
        confidence: 'official',
      ...
      {
        title: {
          en: 'Ampere Capital Market Day Strategic Presentation',
          ko: '암페어 캐피털 마켓 데이 전략 발표',
        },
        url: 'https://www.renaultgroup.com/en/finance/ampere-capital-market-day/',
    ...
    sources: [
      ...
      },
      {
        title: {
          ...
          ko: '혼다 0 시리즈 글로벌 공개 및 전동화 전략 발표',
        },
  ...
  },
  {
    ...
    sources: [
      ...
      {
        title: {
          en: 'Nissan New Mid-Term Business Plan "The Arc" Presentation',
          ko: '닛산 신규 중기 경영 계획 "The Arc" 발표 자료',
        },
        url: 'https://www.nissan-global.com/EN/IR/PRESENTATION/',
        sourceType: 'investor-presentation',
  ...
  },
  {
    ...
    exchange: 'KRX',
    irUrl: {
      en: 'https://worldwide.kia.com/int/investor-relations',
      ko: 'https://worldwide.kia.com/kr/investor-relations',
    },
    latestEventOrReport: {
    ...
    sources: [
      {
        ...
        url: 'https://worldwide.kia.com/int/investor-relations',
        sourceType: 'official-website',
      ...
      {
        title: {
          en: 'Kia CEO Investor Day Strategic Presentation',
          ko: '기아 CEO 인베스터 데이 공식 전략 발표',
        },
        url: 'https://worldwide.kia.com/int/investor-relations/ceo-investor-day',
        sourceType: 'investor-presentation',
        publishedDate: '2024-04-05',
        lastVerified: '2026-09-13',
        confidence: 'official',
  ...
  },
  {
    ...
    ticker: '0175',
    exchange: 'HKEX',
    irUrl: 'https://www.geelyauto.com.hk/investor-relations/',
    latestEventOrReport: {
    ...
    sources: [
      {
        title: {
          en: 'Geely Automobile Holdings Limited Official IR Portal',
          ko: '지리 자동차 홀딩스 공식 투자자 정보 포털',
        },
        url: 'https://www.geelyauto.com.hk/investor-relations/',
        sourceType: 'official-website',
      ...
      {
        title: {
          en: 'Smart Geely 2025 Strategy & Technology Release',
          ko: '스마트 지리 2025 전략 및 기술 브리핑',
        },
        url: 'https://global.geely.com/en/news/2021/smart-geely-2025',
        sourceType: 'official-event',
    ...
    sources: [
      ...
      },
      {
        title: {
          ...
          ko: '상하이 자동차 연례 전략 및 경영 공시 자료',
        },
        url: 'https://www.saicmotor.com/english/investor_relations/financial_reports/',
        sourceType: 'annual-report',
        publishedDate: '2024-04-28',
        lastVerified: '2026-09-13',
        confidence: 'official',
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        url: 'https://www.mahindra.com/investor-relations/reports-and-filings',
        sourceType: 'investor-presentation',
